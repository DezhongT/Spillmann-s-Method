...
setInput::setInput()
{
  ...
  // AddOption("GJ", "Torsional stiffness", GJ);
  ...
  AddOption("friction", "Coefficient of friction", friction);
  AddOption("statictime", "Time of keeping static", statictime);
  AddOption("v_constant", "Const velocity", v_constant);
